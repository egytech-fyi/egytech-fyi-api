      ...
      schemas:
        Participant:
          ...
          properties:
            ...
            csDegree:
              type: string
              description: Indicates whether the participant has a CS related degree ('Yes' or 'No').
            businessMarket:
              type: string
              description: Market in which the participant's business operates (empty string if not specified).
            businessSize:
              type: string
            ...
            industries:
              type: string
              description: List of industries in which the participant's company is involved, separated by commas.
            workSetting:
              type: string
            ...
            netCompensation:
              type: integer
              format: int64
              description: The total annual compensation of the participant in Egyptian pounds, if applicable.
            location:
              type: string
